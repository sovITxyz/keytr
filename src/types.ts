...
export interface EncryptedNsecBlob {
  version: number       // 1 byte (blob format version)
...
export interface EncryptOptions {
  ...
  keyMaterial: Uint8Array     // 32-byte encryption key
...
export interface KeyStrategy {
  ...
  register(options: RegisterOptions): Promise<{ credential: KeytrCredential; keyMaterial: Uint8Array }>
